...
def flatten_case_for_log_analytics(case: CredentialCase) -> dict[str, Any]:
    ...
    return {
        ...
        "CherwellCreatedAt": _datetime(case.cherwell_created_at),
        "CherwellCompletedAt": _datetime(case.cherwell_completed_at),
...
def flatten_archive_for_log_analytics(entry: ArchiveEntry) -> dict[str, Any]:
    return {
        ...
        "CherwellId": entry.details.get("cherwellChangeId"),
        "CherwellNumber": entry.details.get("cherwellChangeNumber"),
